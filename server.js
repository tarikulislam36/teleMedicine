...
console.log(connectedSockets);
    ...
    socket.on('newOffer', (data) => {
        ...
        // send offer to specific user only
 ...
 //when a user disconnects, remove them from the connectedSockets array
    ...
    */
    ...
    socket.on('hangUp', data => {
        const { toUser } = data;
        const RemoteUsertoHagup = connectedSockets.find(s => s.userName === toUser);
        if (!RemoteUsertoHagup) {
            console.log("No matching socket");
            return;
        }
        const socketIdToAnswer = RemoteUsertoHagup.socketId;
